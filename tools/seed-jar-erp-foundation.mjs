...
const JARS = [
  ...
  },
  {
    ...
    moq: 128,
    defaultUnitCost: 2.78,
    tiers: [
      { minQty: 1, maxQty: 249, unitCost: 2.78, notes: "Cost Calculator preset <250" },
      { minQty: 250, maxQty: 499, unitCost: 2.54, notes: "Cost Calculator preset 250+" },
      { minQty: 500, maxQty: 999, unitCost: 2.31, notes: "Cost Calculator preset 500+" },
      { minQty: 1000, maxQty: 2499, unitCost: 2.14, notes: "Cost Calculator preset 1,000+" },
      { minQty: 2500, maxQty: null, unitCost: 1.99, notes: "Cost Calculator preset 2,500+" },
    ],
  },
  {
    key: "jar_100ml_wide",
