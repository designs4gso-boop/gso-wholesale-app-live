...
export const LABOR_STANDARDS: LaborStandard[] = [
  ...
  { key: "bag-4x5-application", task: "4x5 bag application", kind: "hand", hourlyCost: 20, minSpeed: "256 labels/hr", basis: "per applied LABEL (labels, not bags)", unitCost: 20 / 256, note: "NORMAL canonical standard $0.078125/label (front only = 1 label/bag = $0.0781; front + back = 2 labels/bag = $0.15625). Conservative/new-operator PLANNING REFERENCE: 180 labels/hr = $0.1111/label — never used in canonical quoting (15G.2A)." },
